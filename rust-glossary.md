...
caller                           | 调用者                        |
capture                          | 捕获                          |
cargo                            | (Rust 软件包管理器，不译)     | 该词作名词是意思是“货物”，作动词时意思是“装载货物”
...
inference                        | 推导（名词）                  |
inheritance                      | 继承                          |
integrated development environment(IDE) | 集成开发环境，中文著作中通常写直接写 IDE |
...
**T**                            |                               |
tagged union                     | 标记联合                      |
target triple                    | 多层次指标，三层/重 指标/目标 | triple本义是“三”，但此处虚指“多”，此词翻译需要更多讨论
terminal                         | 终端                          |
testing                          | 测试                          |
testsuit                         | 测试套件                      |
